...
cd "C:\Users\Matheus\Desktop\Matheus - Pédimoça\studies\ufv\econometria\minitoria adauto\resultados"
...
**sempre deve ser extraidos os dados de controle, serie, psu e strato e serve para juntar os dados dde domicilios e pessoas
**para extrair os dados da PNAD
...
using "C:\Users\Matheus\Desktop\Matheus - Pédimoça\studies\ufv\econometria\minitoria adauto\dados\PNAD_2014\Dados\DOM2014.txt",clear;
#delimit cr
...
**deve ser extraidos os pesos, visto que os dados são complexos
***fundamental para rodar estatistica descritivas
***na duvida usar o peso de pessoas
...
using "C:\Users\Matheus\Desktop\Matheus - Pédimoça\studies\ufv\econometria\minitoria adauto\dados\PNAD_2014\Dados\PES2014.txt",clear;
#delimit cr 
...
***vai juntar as informações que tem controle igual e serie igual
#delimit cr
...
***se mudar o nome no peso deve ser mudando aquii&&&&&&
...
***elimina estratos com psu unico, o psu unico é alocado ao estrato mais proximo pra evitar tal problema
drop strat psu
rename newstr strat
rename newpsu psu
...
***svy linearized para fazer a estatistica descritiva com relação aos pesos
***pode ser que muda o comando dado a versão do stata
...
**roda-se o logit e o probit para comparar ql é o melhor modelo
*Logit e Probit:
**não é colocado todas as dummies... uma é a base, ou seja, deve ser comparado com a base, se for significativa o efeito dela é estatisticamente significativo com referencia a região base
...
*curva roc sai um grafico e a area sob a curva maior area melhor o ajustamento junta todos os stat class possível
*deve ser inserido o intervalo de confiança para ver se são mesmo diferentes
...
**optou-se pela análise de cenários
**margins para os individuos com tais caracteristicas ql é a probabilidade de tais individuos obterem sucesso no evento de analise
