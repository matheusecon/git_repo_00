...
save PnadEmp13a15desempregado, replace

**Gerando Renda Deflacionada**
gen RendaRealMPC = Deflacionamento * RMDPC

gen DesempregCoorte =.
replace DesempregCoorte =1 if desempregado >=0.2184
replace DesempregCoorte =0 if DesempregCoorte ==.
 
save PnadEmp13a15desempregadocoorts, replace
